...
export const CategoriesList = () => {
  ...
  const doApi = async () => {
    try {
      ...
      alert('ther are problem, come back later')
    }
  }
  ...
  return (
    <div className='container'>
      ...
      <Link className='btn btn-info' to= '/admin/categories/new'>  add new categorie </Link>
          ...
          return (
            <tr key={item._id}>
              ...
              <td>
                  ...
                  <button onClick={()=> {nav('/admin/categories/edit/'+item._id)}} className='bg-info ms-2'>Edit</button>
                </td>
