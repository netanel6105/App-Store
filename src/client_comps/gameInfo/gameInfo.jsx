...
import { API_URL, doApiGet, fixImageUrl } from '../../services/apiServices'
        ...
        <React.Fragment>
          <div className="row">
            ...
            <article className='col-md-8'>
              ...
              {/* substring(0,10)-> חותך סטרינג במקרה הזה את התאריך שמגיע עם שעה */}
              <div className='lead'>Date added: {info.date.substring(0,10)}</div>
